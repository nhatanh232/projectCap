        ...
        TransactionService.getInstance().getTransaction(ScanResultActivity.this, transactionId, role, new VolleyCallBack() {
            ...
            public void onSuccess(Object response) {
                try {
                    ...
                    if (transactionStatus == 4 || (transactionStatus > 1 && role.equals(CONST.ROLE_VETERINARY))
        ...
        FoodService.getInstance().getFoods(ScanResultActivity.this, foodId, new VolleyCallBack() {
            ...
            public void onSuccess(Object response) {
                ...
                try {
                    ...
                    String certiNum = jsonNode.get("Farm").get("CertificationNumber").asText();
                    if(certiNum.equalsIgnoreCase("null")){
                        txtCertificationNumber.setText("Không có thông tin");
                    }else{
                        txtCertificationNumber.setText(certiNum);
                    }
                    //get Feedings
...
//                                providerDto.setAddress(objNode.get("Address").asText());
                                ...
                                // NSX & HSD
                                String mfgDate = objNode.get("Packaging").get("PackagingDate").asText();
                                if(mfgDate.equalsIgnoreCase("null")){
                                    txtMFGDate.setText("Không có thông tin");
                                }else{
                                    txtMFGDate.setText(mfgDate.substring(0,10));
                                }
                                String expDate = objNode.get("Packaging").get("EXPDate").asText().substring(0,10);
                                if(expDate.equalsIgnoreCase("null")){
                                    txtEXPDate.setText("Không có thông tin");
                                }else {
...
//
    ...
    public void loadFoodData2(final int foodId) {
        FoodService.getInstance().getFoodsPro(ScanResultActivity.this, foodId, providerId, new VolleyCallBack() {
            @Override
            public void onSuccess(Object response) {
...
//                                providerDto.setAddress(objNode.get("Address").asText());
                                ...
                                String certiNum = objNode.get("CertificationNumber").asText();
                                if(certiNum.equalsIgnoreCase("null")){
                                    txtCertificationNumber.setText("Không có thông tin");
                                }else{
                                    txtCertificationNumber.setText(certiNum);
...
//
    ...
    public void confirmTransaction() {
        ...
        TransactionService.getInstance().updateTransaction(ScanResultActivity.this, transactionId, status, reason, role, userID, new VolleyCallBack() {
            @Override
            public void onSuccess(Object response) {
                Toast.makeText(ScanResultActivity.this, "Cập nhật giao dịch thành công", Toast.LENGTH_SHORT).show();
            }

            @Override
            public void onError(Object ex) {
                Toast.makeText(ScanResultActivity.this, "Đã có lỗi xảy ra", Toast.LENGTH_SHORT).show();
            }
        });
