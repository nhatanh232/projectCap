...
//                        Toast.makeText(context, response, Toast.LENGTH_SHORT).show();
    ...
    public void getFoodsPro(final Context context, int foodId, int providerId, final VolleyCallBack volley) {
        RequestQueue requestQueue = Volley.newRequestQueue(context);
        String URL = CONST.LOCAL_HOST + "api/Staff/getFoodDataByProvider?id=" + foodId + "&providerId=" + providerId;
//        String URL = "https://api.myjson.com/bins/ogv7p";
